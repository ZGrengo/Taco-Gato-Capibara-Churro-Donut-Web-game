...
export const PileCenter = forwardRef<HTMLDivElement, PileCenterProps>(
  ({ pileCount, topCard, backSrc, impactKey = 0, shakeKey = 0, oopsKey = 0, children }, ref) => {
    ...
    const getAnimateProps = () => {
      ...
      return Object.keys(animations).length > 0 ? animations : {};
    };
    ...
    return (
      <div ref={ref} className="relative w-full max-w-sm">
        <motion.div
          key={shakeKey > 0 ? `shake-${shakeKey}` : `impact-${impactKey}`}
        ...
        >
          ...
          {/* Top card and clickable content */}
          <div className="relative" style={{ zIndex: MAX_PILE_LAYERS + 1 }}>
            {children}
          </div>
